...
contract StandardToken is ERC20, ERC223 {
   ...
   function StandardToken() public {
       _name = "WaterHealthCare";                                   // Set the name for display purposes
       _decimals = 18;                            // Amount of decimals for display purposes
       _symbol = "WAC";                               // Set the symbol for display purposes
       _totalSupply = 10000000000000000000000000000;                        // Update total supply (100000 for example)
